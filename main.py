...
def attack(char_name: str, char_class: str) -> str:
    """Calculate and print attack dmg value based on player character class."""
...
def defence(char_name: str, char_class: str) -> str:
    """Calculate and print block value based on player character class."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Print special attack based on player character class."""
    if char_class == 'warrior':
